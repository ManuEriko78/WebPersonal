...
export interface ApiContactMessagesContactMessages
  extends Struct.CollectionTypeSchema {
  collectionName: 'contact_message';
  info: {
    displayName: 'Contact Messages';
    pluralName: 'contact-message';
    singularName: 'contact-messages';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    estado: Schema.Attribute.Enumeration<['new', 'read', 'archived']> &
...
export interface ApiCvCv extends Struct.SingleTypeSchema {
  ...
  attributes: {
    courses_languages: Schema.Attribute.RichText;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::contact-messages.contact-messages': ApiContactMessagesContactMessages;
      'api::cv.cv': ApiCvCv;
